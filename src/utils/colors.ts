...
export const NODE_COLORS: Record<NodeType, { bg: string; border: string; text: string }> = {
  topic:    { bg: 'rgba(245, 158, 11, 0.12)', border: '#f59e0b', text: '#fbbf24' },
  point:    { bg: 'rgba(6, 182, 212, 0.12)',   border: '#06b6d4', text: '#22d3ee' },
  detail:   { bg: 'rgba(139, 92, 246, 0.12)',  border: '#8b5cf6', text: '#a78bfa' },
  action:   { bg: 'rgba(16, 185, 129, 0.12)',  border: '#10b981', text: '#34d399' },
  question: { bg: 'rgba(244, 63, 94, 0.12)',   border: '#f43f5e', text: '#fb7185' },
};
